 ...
 */
function buildScenarioTone(scenario) {
 ...
 */
function buildActiveLevelLogic() {
 ...
 */
function buildVisualEnhancement() {
...
// ============================================================================
export function buildSystemPrompt(scenario = "dungeon", locale = "en-US") {
    return [
        buildCoreIdentity(),
        "",
...
export function buildActionPrompt(action, context) {
